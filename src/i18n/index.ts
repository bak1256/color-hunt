...
const ja: Dict = {
  ...
  "연습장으로 돌아가기": "練習場に戻る",
  "위치 확인 완료": "位置を確認しました",
  "시간 종료! 남은 봇의 위치를 확인하세요.": "時間切れ！残っているBOTの位置を確認してください。",
  "탄약 소진! 남은 봇의 위치를 확인하세요.": "弾薬切れ！残っているBOTの位置を確認してください。",
...
const en: Dict = {
  ...
  "여행의 나라": "Travel Land",
  "디저트의 나라": "Dessert Land",
  "랜드마크의 나라": "Landmark Land",
  "대충의 나라": "Roughly-Drawn Land",
  "스틱액션의 나라": "Stick Action Land",
  ...
  "위치 확인 완료": "Done Reviewing Positions",
  "시간 종료! 남은 봇의 위치를 확인하세요.": "Time up! Review the remaining bot positions.",
  "탄약 소진! 남은 봇의 위치를 확인하세요.": "Out of ammo! Review the remaining bot positions.",
...
const zh: Dict = {
  ...
  "연습장으로 돌아가기": "返回练习场",
  "위치 확인 완료": "已确认位置",
  "시간 종료! 남은 봇의 위치를 확인하세요.": "时间结束！请确认剩余机器人的位置。",
  "탄약 소진! 남은 봇의 위치를 확인하세요.": "弹药耗尽！请确认剩余机器人的位置。",
...
/* V1010450O_PAINT_HELP_TRANSLATION_SWEEP
 * Paint Help / difficulty / paint-tool strings and static tr() gaps.
 */
Object.assign(ko, {
  '직선':'직선','아주 쉬움':'아주 쉬움','쉬움':'쉬움','보통':'보통','어려움':'어려움','아주 어려움':'아주 어려움',
  '색칠 도움받기':'색칠 도움받기','색칠 도움받음':'색칠 도움받음','색칠고수':'색칠고수','색칠새싹':'색칠새싹',
  '준비완료':'준비완료','방이 가득 찼습니다. 잠시 후 다시 시도하세요.':'방이 가득 찼습니다. 잠시 후 다시 시도하세요.'
});
Object.assign(ja, {
  '직선':'直線','아주 쉬움':'とても簡単','쉬움':'簡単','보통':'普通','어려움':'難しい','아주 어려움':'とても難しい',
  '색칠 도움받기':'色塗りを手伝ってもらう','색칠 도움받음':'色塗りサポート済み','색칠고수':'色塗りマスター','색칠새싹':'色塗りビギナー',
  '준비완료':'準備完了','방이 가득 찼습니다. 잠시 후 다시 시도하세요.':'ルームが満員です。しばらくしてからもう一度お試しください。'
});
Object.assign(en, {
  '직선':'Line','아주 쉬움':'Very Easy','쉬움':'Easy','보통':'Normal','어려움':'Hard','아주 어려움':'Very Hard',
  '색칠 도움받기':'Get Paint Help','색칠 도움받음':'Paint Help Received','색칠고수':'Paint Master','색칠새싹':'Paint Beginner',
  '준비완료':'READY','방이 가득 찼습니다. 잠시 후 다시 시도하세요.':'Room is full. Please try again shortly.'
});
Object.assign(zh, {
  '직선':'直线','아주 쉬움':'非常简单','쉬움':'简单','보통':'普通','어려움':'困难','아주 어려움':'非常困难',
  '색칠 도움받기':'获取上色帮助','색칠 도움받음':'已获得上色帮助','색칠고수':'上色高手','색칠새싹':'上色新手',
  '준비완료':'准备完成','방이 가득 찼습니다. 잠시 후 다시 시도하세요.':'房间已满，请稍后再试。',
  'Keyboard input is unavailable.':'键盘输入不可用。','TIME 0':'时间 0','DOT CIRCLE':'点状圆形',
  'SMOOTH CIRCLE':'平滑圆形','SQUARE DOT':'方形点','🌿 HIDER VICTORY':'🌿 HIDER 获胜','🏆 HUNTER VICTORY':'🏆 HUNTER 获胜'
});
...
/* V101023814_TRANSLATION_SWEEP */
Object.assign(ko, {
  '과열':'과열',
  '과열 직전!':'과열 직전!',
  '과열! 발사 불가':'과열! 발사 불가',
  '다음 맵':'다음 맵',
  '모든 탄약을 사용했습니다. 다시 연습해서 탄약 관리와 과열 타이밍을 익혀보세요.':'모든 탄약을 사용했습니다. 다시 연습해서 탄약 관리와 과열 타이밍을 익혀보세요.',
  '발사':'발사',
  '샷건 과열! 잠시 식힌 후 발사하세요':'샷건 과열! 잠시 식힌 후 발사하세요',
  '연습 시작! 자유롭게 색칠해보세요.':'연습 시작! 자유롭게 색칠해보세요.',
  '연습할 맵을 선택하세요':'연습할 맵을 선택하세요',
  '열 상승':'열 상승',
  '이전 맵':'이전 맵',
  '좌우 화살표로 연습할 맵을 고르세요. 선택한 맵에서 헌터·하이더 연습을 시작합니다.':'좌우 화살표로 연습할 맵을 고르세요. 선택한 맵에서 헌터·하이더 연습을 시작합니다.',
  '좌클릭':'좌클릭',
  '탄약 소진!':'탄약 소진!',
  '탄약 소진! HIDER 승리!':'탄약 소진! HIDER 승리!',
  '탄약 소진! 연습 종료':'탄약 소진! 연습 종료',
  '맵 미상':'맵 미상'
});
Object.assign(ja, {
  '과열':'オーバーヒート',
  '과열 직전!':'オーバーヒート寸前！',
  '과열! 발사 불가':'オーバーヒート！射撃不可',
  '다음 맵':'次のマップ',
  '모든 탄약을 사용했습니다. 다시 연습해서 탄약 관리와 과열 타이밍을 익혀보세요.':'弾薬をすべて使い切りました。もう一度練習して、弾薬管理とオーバーヒートのタイミングを身につけましょう。',
  '발사':'発射',
  '샷건 과열! 잠시 식힌 후 발사하세요':'ショットガンがオーバーヒート！少し冷ましてから撃ってください。',
  '연습 시작! 자유롭게 색칠해보세요.':'練習開始！自由に塗ってみましょう。',
  '연습할 맵을 선택하세요':'練習するマップを選んでください',
  '열 상승':'熱上昇',
  '이전 맵':'前のマップ',
  '좌우 화살표로 연습할 맵을 고르세요. 선택한 맵에서 헌터·하이더 연습을 시작합니다.':'左右の矢印で練習するマップを選んでください。選んだマップでHUNTER・HIDER練習を開始します。',
  '좌클릭':'左クリック',
  '탄약 소진!':'弾薬切れ！',
  '탄약 소진! HIDER 승리!':'弾薬切れ！HIDERの勝利！',
  '탄약 소진! 연습 종료':'弾薬切れ！練習終了',
  '맵 미상':'マップ不明'
});
Object.assign(en, {
  '과열':'OVERHEAT',
  '과열 직전!':'OVERHEAT IMMINENT!',
  '과열! 발사 불가':'OVERHEATED! CANNOT FIRE',
  '다음 맵':'Next Map',
  '모든 탄약을 사용했습니다. 다시 연습해서 탄약 관리와 과열 타이밍을 익혀보세요.':'You used all your ammo. Practice again to improve ammo management and overheat timing.',
  '발사':'Fire',
  '샷건 과열! 잠시 식힌 후 발사하세요':'Shotgun overheated! Let it cool before firing.',
  '연습 시작! 자유롭게 색칠해보세요.':'Practice started! Paint freely.',
  '연습할 맵을 선택하세요':'Choose a practice map',
  '열 상승':'HEAT RISING',
  '이전 맵':'Previous Map',
  '좌우 화살표로 연습할 맵을 고르세요. 선택한 맵에서 헌터·하이더 연습을 시작합니다.':'Use the left and right arrows to choose a practice map. Hunter and Hider practice will use the selected map.',
  '좌클릭':'Left click',
  '탄약 소진!':'OUT OF AMMO!',
  '탄약 소진! HIDER 승리!':'OUT OF AMMO! HIDER WINS!',
  '탄약 소진! 연습 종료':'OUT OF AMMO! PRACTICE OVER',
  '맵 미상':'Unknown map'
});
Object.assign(zh, {
  '과열':'过热',
  ...
  '과열! 발사 불가':'过热！无法射击',
  '다음 맵':'下一张地图',
  '모든 탄약을 사용했습니다. 다시 연습해서 탄약 관리와 과열 타이밍을 익혀보세요.':'弹药已全部用完。再次练习，掌握弹药管理和过热时机吧。',
  '발사':'射击',
  '샷건 과열! 잠시 식힌 후 발사하세요':'霰弹枪过热！请稍等冷却后再射击。',
  '연습 시작! 자유롭게 색칠해보세요.':'练习开始！自由涂色吧。',
  '연습할 맵을 선택하세요':'请选择练习地图',
  '열 상승':'热量上升',
  '이전 맵':'上一张地图',
  '좌우 화살표로 연습할 맵을 고르세요. 선택한 맵에서 헌터·하이더 연습을 시작합니다.':'使用左右箭头选择练习地图。HUNTER和HIDER练习将在所选地图中开始。',
  '좌클릭':'鼠标左键',
  '탄약 소진!':'弹药耗尽！',
  '탄약 소진! HIDER 승리!':'弹药耗尽！HIDER胜利！',
  '탄약 소진! 연습 종료':'弹药耗尽！练习结束',
  '맵 미상':'未知地图'
});
