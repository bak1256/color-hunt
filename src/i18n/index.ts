 ...
 * New Paint Help / difficulty / paint-tool strings plus static tr() gaps found
 * by comparing current GameScene.ts calls against KO/JA/EN/ZH dictionaries.
 */
Object.assign(ko, {
  '직선':'직선',
  '아주 쉬움':'아주 쉬움',
  ...
  '색칠새싹':'색칠새싹',
  '준비완료':'준비완료',
  '방이 가득 찼습니다. 잠시 후 다시 시도하세요.':'방이 가득 찼습니다. 잠시 후 다시 시도하세요.'
});
Object.assign(ja, {
  '직선':'直線',
  '아주 쉬움':'とても簡単',
  ...
  '색칠새싹':'色塗りビギナー',
  '준비완료':'準備完了',
  '방이 가득 찼습니다. 잠시 후 다시 시도하세요.':'ルームが満員です。しばらくしてからもう一度お試しください。'
});
Object.assign(en, {
  '직선':'Line',
  '아주 쉬움':'Very Easy',
  ...
  '어려움':'Hard',
  '아주 어려움':'Very Hard',
  '색칠 도움받기':'Get Paint Help',
  '색칠 도움받음':'Paint Help Received',
  '색칠고수':'Paint Master',
  '색칠새싹':'Paint Beginner',
  '준비완료':'READY',
  '방이 가득 찼습니다. 잠시 후 다시 시도하세요.':'Room is full. Please try again shortly.'
});
Object.assign(zh, {
  '직선':'直线',
  '아주 쉬움':'非常简单',
  ...
  '색칠새싹':'上色新手',
  '준비완료':'准备完成',
  '방이 가득 찼습니다. 잠시 후 다시 시도하세요.':'房间已满，请稍后再试。',
  'Keyboard input is unavailable.':'键盘输入不可用。',
  'TIME 0':'时间 0',
  'DOT CIRCLE':'点状圆形',
  'SMOOTH CIRCLE':'平滑圆形',
  'SQUARE DOT':'方形点',
  '🌿 HIDER VICTORY':'🌿 HIDER 获胜',
  '🏆 HUNTER VICTORY':'🏆 HUNTER 获胜'
});


/* V1010450V_HUNTER_FART_HINT_I18N */
Object.assign(ko, {
  '못 찾겠다면… 💨 SPACE로 방구 탐지! 코로 찾는 것도 실력이지!':
    '못 찾겠다면… 💨 SPACE로 방구 탐지! 코로 찾는 것도 실력이지!',
  '못 찾겠다면… 💨 방구 버튼으로 탐지! 코로 찾는 것도 실력이지!':
    '못 찾겠다면… 💨 방구 버튼으로 탐지! 코로 찾는 것도 실력이지!'
});
Object.assign(ja, {
  '못 찾겠다면… 💨 SPACE로 방구 탐지! 코로 찾는 것도 실력이지!':
    '見つからない…？ 💨 SPACEでおなら探知！鼻で探すのも実力だ！',
  '못 찾겠다면… 💨 방구 버튼으로 탐지! 코로 찾는 것도 실력이지!':
    '見つからない…？ 💨 おならボタンで探知！鼻で探すのも実力だ！'
});
Object.assign(en, {
  '못 찾겠다면… 💨 SPACE로 방구 탐지! 코로 찾는 것도 실력이지!':
    "Can't find them? 💨 Press SPACE for Fart Detect! Hunting by nose counts too!",
  '못 찾겠다면… 💨 방구 버튼으로 탐지! 코로 찾는 것도 실력이지!':
    "Can't find them? 💨 Tap the FART button! Hunting by nose counts too!"
});
Object.assign(zh, {
  '못 찾겠다면… 💨 SPACE로 방구 탐지! 코로 찾는 것도 실력이지!':
    '找不到吗？💨 按 SPACE 放屁探测！用鼻子找也算本事！',
  '못 찾겠다면… 💨 방구 버튼으로 탐지! 코로 찾는 것도 실력이지!':
